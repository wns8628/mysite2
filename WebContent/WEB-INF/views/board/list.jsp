					...
					<c:forEach items="${list}" var="vo" varStatus="status">				
						...
						<c:if test="${vo.depth > 0}" >
							...
							<td style="padding-left:${15*vo.depth}px">
								...
								<a href="${pageContext.servletContext.contextPath }/board?a=view&no=${vo.no}&kwd=${page.kwd}">
							...
							<td>${vo.hit }</td>
							<td>${vo.writeDate }</td>
							<td><a href="${pageContext.servletContext.contextPath }/board?a=delete&no=${vo.no}" class="del"><img src="${pageContext.servletContext.contextPath }/assets/images/recycle.png">삭제</a></td>
						</tr>
				...
				<c:choose>
					...
					<div class="pager">
		               <ul>	            
						...
						<li><a href="${pageContext.servletContext.contextPath }/board?a=list&pageNo=1&kwd=${page.kwd}">◁◁</a></li>   
						<li><a href="${pageContext.servletContext.contextPath }/board?a=list&pageNo=${page.pageNo-1}&kwd=${page.kwd}">◀</a></li>		                  
						  <c:forEach var="i" begin="${page.startPage }" end="${limitnumber}" step="1">	  							  	
						  	<c:choose>				
						  		<c:when test="${page.pageNo == i}">
								  	 <li class="selected">
					                  	<a href="${pageContext.servletContext.contextPath }/board?a=list&pageNo=${i}&kwd=${page.kwd}">
					                  		${i}
					                  	</a>
				                  	 </li>
						  		</c:when>
		                 ...
		                 <li><a href="${pageContext.servletContext.contextPath }/board?a=list&pageNo=${page.pageNo+1}&kwd=${page.kwd}">▶</a></li>
		                 <li><a href="${pageContext.servletContext.contextPath }/board?a=list&pageNo=${page.totalpage}&kwd=${page.kwd}">▷▷</a></li>	               
		               </ul>
		            </div>
		         <!--  --> 
